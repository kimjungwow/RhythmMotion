...
public class BootyBounce : MonoBehaviour
{ 
    ...
    private List<float> music1 = new List<float>() {3,0,2,1,3,0,2,1,0,0,3,3,1,1,2,2,1,3,0,2,1,3,0,2,0,3,3,1,0,2,3,1,0,2};
    private List<float> beat1 = new List<float>() {0.93f, 0.93f, 0.93f, 0.93f, 0.91f, 0.91f, 0.91f, 0.91f, 0.89f, 0.89f, 0.89f, 0.89f, 0.89f, 0.89f, 0.89f, 0.89f, 0.87f, 0.87f, 0.87f, 0.87f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f, 0.9f };
    ...
    IEnumerator spawnNote(List<float> music, List<float> beat)
    {
        ...
        else if(NoteMark >= 34 && NoteMark < 39)
        {
            if (music[NoteMark] == 0)
            {
                xPos = -9f;
        ...
        else if(NoteMark>=39 && NoteMark < 102)
        {
            if (music[NoteMark] == 0)
            {
                xPos = -9f;
